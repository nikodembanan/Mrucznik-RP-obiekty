...
PushActors()
{
	...
	CreateActorEx(20401, "Beyonce_NieBennett", 1455.7231, -1792.1993, 77.9612, 89.1325, 1, 40.0, 50, -1, -1); 
	CreateActorEx(147, "Mark_Meon", 1455.7333,-1795.4087,77.9612,88.5058, 1, 40.0, 50, -1, -1);
	/*
		AddPlayerClass(20301,1455.7231,-1792.1993,77.9612,89.1325,0,0,0,0,0,0); // urzednik1
		AddPlayerClass(20301,1455.7333,-1795.4087,77.9612,88.5058,0,0,0,0,0,0); // urzednik2
		AddPlayerClass(20301,1455.7354,-1798.5978,77.9612,88.5058,0,0,0,0,0,0); // urzednik3
		AddPlayerClass(20301,1455.7334,-1801.7968,77.9502,88.5058,0,0,0,0,0,0); // urzednik4
		AddPlayerClass(20301,1445.2711,-1791.3987,77.9502,269.9041,0,0,0,0,0,0); // urzednik5
		AddPlayerClass(20301,1445.2773,-1794.7145,77.9612,269.9041,0,0,0,0,0,0); // urzednik6
		AddPlayerClass(20301,1445.3197,-1797.8114,77.9612,269.9041,0,0,0,0,0,0); // urzednik7
		AddPlayerClass(20301,1445.2811,-1801.1071,77.9612,269.9041,0,0,0,0,0,0); // urzednik8
	*/ 
